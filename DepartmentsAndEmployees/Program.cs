...
namespace DepartmentsAndEmployees
{
    class Program
    {
        ...
        public static void PrintDepartmentReport(string title, List<Department> departments)
        {
            ...
            foreach (Department DeptName in departments)
            {
                string departmentName = DeptName.DeptName;
                int departmentId = DeptName.Id;
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            foreach (Employee emp in employees)
            {
                ...
                {
                    Console.WriteLine($"{id}: {firstName} {lastName}. Dept: {emp.Department.DeptName}");
                } else
                {
